		...
		<div class="profile-right">
			<div class="name-group">
				...
				<c:choose>
					...
					<c:otherwise>
						<c:choose>
							<c:when test="${userInfo.subscribeState}">
								<button class="cta blue" onclick="toggleSubscribe(${userInfo.user.id}, this)">구독취소</button>
							</c:when>
							<c:otherwise>
								<button class="cta" onclick="toggleSubscribe(${userInfo.user.id}, this)">구독하기</button>
							</c:otherwise>
						</c:choose>
					</c:otherwise>
				</c:choose>
			...
			<div class="subscribe">
				<ul>
					...
					<li><a href="javascript:subscribeInfoModalOpen(${userInfo.user.id});"> 구독정보<span>${userInfo.subscribeCount}</span>
					</a></li>
				</ul>
			</div>
			<div class="state">
